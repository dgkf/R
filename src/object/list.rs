...
struct List2(Rep<Obj>);

impl From<Rep<Obj>> for List2 {
    fn from(x: Rep<Obj>) -> Self {
        List2(x)
    }
}
...
impl List2 {
    ...
    pub fn materialize(self) -> Self {
        List2::from(self.0.materialize())
    }

    pub fn assign(&mut self, other: Obj) -> EvalResult {
        // TODO: Rep<Obj> currently does not handle names.
        todo!()
    }
