...
export function __wbg_set_cli_locale(a: number, b: number): void;
export function __wbg_get_cli_warranty(a: number): number;
export function __wbg_set_cli_warranty(a: number, b: number): void;
export function __wbg_get_cli_experiments(a: number, b: number): void;
export function __wbg_set_cli_experiments(a: number, b: number, c: number): void;
export function __wbindgen_malloc(a: number, b: number): number;
export function __wbindgen_realloc(a: number, b: number, c: number, d: number): number;
export const __wbindgen_export_2: WebAssembly.Table;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function _dyn_core__ops__function__Fn__A_B___Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h489eab4204a9e42b(a: number, b: number, c: number, d: number, e: number, f: number): void;
